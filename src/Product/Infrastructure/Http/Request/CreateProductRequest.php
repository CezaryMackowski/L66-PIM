...
final readonly class CreateProductRequest
{
    public function __construct(
        #[OA\Property(type: 'string', maxLength: 255, example: 'Classic T-Shirt')]
        #[Assert\NotBlank]
        #[Assert\Length(max: 255)]
        public string $name,
        #[OA\Property(type: 'string', maxLength: 64, example: 'TSHIRT-CLASSIC-001')]
        #[Assert\NotBlank]
        #[Assert\Length(max: 64)]
        #[Assert\Regex(pattern: '/^[A-Za-z0-9_-]+$/')]
        public string $sku,
        #[OA\Property(type: 'string', example: '129.99')]
        #[Assert\NotBlank]
